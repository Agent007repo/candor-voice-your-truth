    ...
    <div className="min-h-screen bg-gradient-secondary">
        ...
        <div className="relative container mx-auto px-4 py-24">
          <div className="text-center text-white">
            <h1 className="text-6xl font-bold mb-6 tracking-tight">
              Welcome to <span className="text-yellow-300">Candor</span>
            </h1>
      ...
      <div className="container mx-auto px-4 py-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card 
              key={index}
              className={`glass transition-all duration-300 transform cursor-pointer ${
                hoveredCard === index ? 'scale-105 shadow-candor-lg' : 'shadow-candor-md'
              }`}
      ...
      <div className="container mx-auto px-4 py-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            size="lg" 
            className="bg-gradient-primary hover:bg-primary-hover font-semibold px-8 py-6 text-lg"
